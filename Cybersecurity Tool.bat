...
if "%input%" EQU "6" (
 ...
 if "%input%" EQU "99" (
    ...
    curl -o updated_script.bat
    https://github.com/ganeshrajpurohit654/Cyber-Security-Tool-By-Mr.G/blob/main/Cybersecurity%20Tool.bat
    rem Replace the current script with the updated version
    move /y update_script.bat Cybersecurity Tool.bat
